...
const _slideLima = function () {
  ...
  // Hilangkan slideLima dan trims setelah video selesai
  const handleVideoEnd = () => {
    trims.removeEventListener('ended', handleVideoEnd);
    trims.remove();
    slideLima.remove();
    _slideEnam();
  };
  ...
  setTimeout(() => {
    const video = document.getElementById('video-trims');
    if (video) {
...
new TypeIt("#teks1", {
  strings: ["Haloo Mamakk Vynnaaaa.", "Terima kasih yah, karena mamak udah berhasil lewati semuanya sejauh ini.", "Semoga dunia senantiasa ngejagain mamak dimanapun mamakk berada.", "Semoga hari-hari mamakk selalu diiringi cinta yang ga pernah ada batasnya." , "Semoga setiap langkah mamakk dimudahkan hingga tercapai apa yang Mamakk Vynnaaaa inginkan yaa :)"],
  startDelay: 4000,
  speed: 75,
...
// Fungsi pengganti TypeIt untuk #trims, menampilkan video saat trigger
function showTrimsVideo() {
